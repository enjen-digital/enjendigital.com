    ...
    <section id="features" className="py-12 sm:py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 sm:mt-20">
          <div className="bg-yellow-50 rounded-2xl p-4 sm:p-8 md:p-12 overflow-hidden relative isolate">
              ...
              <div className="relative z-0">
                ...
                {[
                  ...
                  <li key={index} className="flex items-center">
                    <div className="w-5 h-5 rounded-full bg-yellow-600 flex items-center justify-center mr-3">
